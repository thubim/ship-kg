...
class Extractor:
    ...
    def extract(self, origin_sentence, sentence, file_path, num, spec_info, item_info):
        """
        Args:
        ...
        for entity_pair in self.entity_pairs:
            ...
            extract_dsnf = ExtractByDSNF(origin_sentence, sentence, entity1, entity2, file_path, num, spec_info, item_info)
